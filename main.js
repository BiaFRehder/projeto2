...
function adicionaContato() {
    ...
    if (telefones.includes(numero)) {
        ...
        linha += `<td>${numero}</td>`;
        linha += `<td><a href="tel:${numero}" target="_blank"  id="btn-ligar"><img src="./images/telefone.png"/></a><button id="btn-excluir" onclick="excluir(${inputName.length -1})">Excluir</button></td>`;
        linha += '</tr>';
...
function atualizaLinhas() {
    ...
    for (let i = 0; i < names.length; i++) {
        ...
        linha += `<td><a href="tel:${inputTel.value}" target="_blank"  id="btn-ligar"><img src="./images/telefone.png"/></a><button id="btn-excluir" onclick="excluir(${i})">Excluir</button></td>`;
        linha += '</tr>';
